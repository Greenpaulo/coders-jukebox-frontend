...
var App = function App(_ref) {
  ...
  var login = function login(email, password) {
    var requestBody, res, data, _data$data, userId, token;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 13:
            ...
            _data$data = data.data, userId = _data$data.userId, token = _data$data.token;
            setAuthState(_objectSpread({}, state, {
              authenticated: true,
              userId: userId,
              token: token
            }));
...
//# sourceMappingURL=_app.js.a4da1e51323742d7f9bc.hot-update.js.map